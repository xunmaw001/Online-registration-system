...
//                            yishengOrderEntity.setYishengOrderUuidNumber(data.get(0));                    //门诊号 要改的
...
//                            yishengOrderEntity.setGuahaoTime(new Date(data.get(0)));          //挂号日期 要改的
//                            yishengOrderEntity.setShijianduanTypes(Integer.valueOf(data.get(0)));   //时间段 要改的
//                            yishengOrderEntity.setYishengOrderTypes(Integer.valueOf(data.get(0)));   //挂号状态 要改的
//                            yishengOrderEntity.setBeizhuContent("");//照片
...
//                            yishengOrderEntity.setCreateTime(date);//时间
                        ...
                        if(yishengOrderEntities_yishengOrderUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [门诊号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R add(@RequestBody YishengOrderEntity yishengOrder, HttpServletRequest request){
        ...
        yishengOrder.setYishengOrderTypes(1);

                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="yishengUuidNumber" id="yishengUuidNumber" placeholder="医生编号" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="yishengName" id="yishengName" placeholder="医生名称" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <select name="yishengTypes" id="yishengTypes" lay-filter="yishengTypes">
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in dataList" v-bind:key="index"  class="col-md-3 list-grid">
                            <i @click="deleteYishengCollection(item.id)" class="layui-icon" style="float:right;color:red;margin-top: 0px;margin-right: 3px;font-size:20px">&#xe640;</i>
                            <div @click="jumpCheck('../yisheng/detail.jsp?id='+item.yishengId , item.yishengDelete == null?'':item.yishengDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            yishengCollectionTypesList : [],
        // 级联表字典表数据
            yishengTypesList : [],
            zhiweiTypesList : [],
            shangxiaTypesList : [],
            yishengCollectionTypes: 0,//类型
            limit: 8,
        ...
        methods: {
            ...
            ,deleteYishengCollection(id){
                layui.layer.confirm('确认要删除这个收藏吗？', {
                    btn : [ '确定', '取消' ]//按钮
                }, function(index) {
                    var paramArray = [];
                    paramArray.push(id);
                    layui.http.requestJson('yishengCollection/delete', 'post',paramArray, function (res) {
                        if (res.code == 0) {
                            layer.msg('删除成功', {
                                time: 2000,
                                icon: 6
    ...
    // 当前表的字典表
        ...
        function yishengCollectionTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yisheng_collection_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.yishengCollectionTypesList = res.data.list;
                }
            });
        }
    ...
    // 级联表的字段数据
        ...
        function pageList() {
            ...
            if (jquery('#yishengUuidNumber').val() != null && jquery('#yishengUuidNumber').val() != "" && jquery('#yishengUuidNumber').val() != "null" ) {
                param['yishengUuidNumber'] = jquery('#yishengUuidNumber').val();
            }
                     
            if (jquery('#yishengName').val() != null && jquery('#yishengName').val() != "" && jquery('#yishengName').val() != "null" ) {
                param['yishengName'] = jquery('#yishengName').val();
            }
                                         
            var yishengTypes = $("#yishengTypes").find("option:selected").val();
            if (yishengTypes != null && yishengTypes != "" && yishengTypes != "null") {
                            param['yishengTypes'] = yishengTypes;
                        }
            ...
            //收藏只能查类型为1的
            param['yishengCollectionTypes'] = 1;

            // 获取列表数据
            http.request('yishengCollection/page', 'get', param, function(res) {

...
<!-- 唯一uuid -->
            <div class="layui-form-item pane>
                ...
                <div class="layui-input-inline">
                    <input  type="text" name="yishengUuidNumber" id="yishengUuidNumber"  lay-verify="required"   placeholder="医生编号" autocomplete="off" class="layui-input" readonly="readonly">
                </div>
            </div>
            <div class="layui-form-item" pane>
                <label class="layui-form-label">医生名称：</label>
                <div class="layui-input-block">
                    <input <%--v-model="detail.yishengName"--%> type="text" name="yishengName" id="yishengName" placeholder="医生名称" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.yishengShanchang"--%> type="text" name="yishengShanchang" id="yishengShanchang" placeholder="擅长" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input <%--v-model="detail.yishengClicknum"--%> type="text" name="yishengClicknum" id="yishengClicknum" lay-verify="integer|required"   placeholder="点击次数" autocomplete="off" class="layui-input">
                </div>
            </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate', 'tinymce'], function () {
        ...
        vue.detail.yishengUuidNumber = new Date().getTime();

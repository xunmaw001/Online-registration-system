            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <section style="margin: 10px">
                        <div class="row">
                            <div v-for="(item,index) in yishengList" class="col-md-3">
                                <div class="gallery-demo" @click="jumpCheck('../yisheng/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <img :src="item.yishengPhoto?item.yishengPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                    <h4 class="p-mask">{{item.yishengName}}
                                        <span v-if="item.yishengNewMoney"> - ￥{{item.yishengNewMoney}}</span>
                                        <span v-else> - {{item.yishengValue}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>

            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">医生挂号登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>是否使用</label>
                                        <input style="width: 450px" id="shiyongValue" name="shiyongValue" class="form-control"
                                               v-model="ruleForm.shiyongValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yishengOrderUuidNumber" name="yishengOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.yishengOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>挂号日期</label>
                                        <input style="width: 450px" id="guahaoTime" name="guahaoTime" class="form-control"
                                               v-model="ruleForm.guahaoTime" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>挂号状态</label>
                                    <input style="width: 450px" id="yishengOrderValue" name="yishengOrderValue" class="form-control"
                                           v-model="ruleForm.yishengOrderValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yishengOrder/info/" + id,

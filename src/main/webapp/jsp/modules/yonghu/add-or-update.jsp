                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shiyongTypesDiv">
                                        <label>是否使用</label>
                                        <select style="width: 450px" id="shiyongTypesSelect" name="shiyongTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 查询列表
        ...
        function shiyongTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shiyong_types", "GET", {}, (res) => {
                if(res.code == 0){
                    shiyongTypesOptions = res.data.list;
                }
            });
        }
        <!-- 查询级联表的所有列表 -->
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationShiyongtypesSelect(){
            var shiyongTypesSelect = document.getElementById('shiyongTypesSelect');
            if(shiyongTypesSelect != null && shiyongTypesOptions != null  && shiyongTypesOptions.length > 0 ){
                for (var i = 0; i < shiyongTypesOptions.length; i++) {
                    shiyongTypesSelect.add(new Option(shiyongTypesOptions[i].indexName,shiyongTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(shiyongTypesSelect != null && shiyongTypesOptions != null  && shiyongTypesOptions.length > 0 ) {
            for (var i = 0; i < shiyongTypesOptions.length; i++) {
                if (shiyongTypesOptions[i].codeIndex == ruleForm.shiyongTypes) {//下拉框value对比,如果一致就赋值汉字
                        shiyongTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationShiyongtypesSelect();
            <!--  初始化级联表的下拉框  -->

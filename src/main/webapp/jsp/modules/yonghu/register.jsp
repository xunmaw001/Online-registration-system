...
<body style="background-image:url('/wangshangguahao/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <div class="form-group col-md-12">
                                       <label>是否使用</label>
                                       <select id="shiyongTypesSelect" name="shiyongTypes" class="form-control">
                                       </select>
                                   </div>
                                <div class="form-group col-md-12">
                                    <label>电子邮箱</label>

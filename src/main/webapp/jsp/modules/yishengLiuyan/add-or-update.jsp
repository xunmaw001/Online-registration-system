    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑医生留言</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑医生留言</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">医生留言信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 yishengLiuyanTextDiv">
                                        <label>留言内容</label>
                                        <textarea style="width: 450px"  id="yishengLiuyanText" name="yishengLiuyanText" class="form-control"placeholder="留言内容"></textarea>
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("yishengLiuyan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addyishengLiuyan');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yishengId: "required",
                yonghuId: "required",
                yishengLiuyanText: "required",
                replyText: "required",
            },
            messages: {
                yishengId: "医生不能为空",
                yonghuId: "用户不能为空",
                yishengLiuyanText: "留言内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addyishengLiuyan = window.sessionStorage.getItem("addyishengLiuyan");
        if (addyishengLiuyan != null && addyishengLiuyan != "" && addyishengLiuyan != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("yishengLiuyan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yishengLiuyanText").val(ruleForm.yishengLiuyanText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#yishengLiuyanText').attr('readonly', 'readonly');
